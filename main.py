...
openai.api_key = "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"
...
@app.route('/tripmuse_home')
def redirect_to_tripmuse_home():
    return render_template('tripmuse_home.html')

@app.route('/itinerary')
def redirect_to_itinerary():
